...
@5 = internal constant [3 x i8] c"4\0A\00"
@6 = internal constant [3 x i8] c"5\0A\00"
@7 = internal constant [5 x i8] c"???\0A\00"
...
entry:
  ...
  %6 = icmp eq i32 %5, 1
  br i1 %6, label %then, label %else4
...
then1:                                            ; preds = %then
  call void (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @5, i32 0, i32 0))
  br label %11
...
11:                                               ; preds = %else3, %then2, %then1
  br label %18

else4:                                            ; preds = %entry
  %12 = getelementptr inbounds %Literal, %Literal* %a, i32 0, i32 0
  %13 = load i32, i32* %12, align 4
  %14 = icmp eq i32 %13, 0
  br i1 %14, label %then5, label %else6

then5:                                            ; preds = %else4
  call void (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @7, i32 0, i32 0))
  br label %18

else6:                                            ; preds = %else4
  %15 = alloca %Literal, align 8
  %16 = bitcast %Literal* %15 to i8*
  %17 = bitcast %Literal* %a to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %16, i8* align 8 %17, i64 24, i1 false)
  call void @print_enum(%Literal* %15)
  br label %18

18:                                               ; preds = %else6, %then5, %11
  ret i32 1
}
