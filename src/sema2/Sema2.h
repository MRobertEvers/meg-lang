...
public:
	...
	std::optional<ir::GeneratorFn>& async_fn_context() { return async_context_; }
	void async_fn_context_set(std::optional<ir::GeneratorFn> ctx) { async_context_ = ctx; }
	...
	ir::IRYield* Yield(ast::AstNode* node, ir::IRExpr*, sema::TypeInstance type_instance);
